...
- **데스크톱(900px 이상):** iPhone 목업(390×844) 안에서 **체크인 → 오늘 방문 → 체크인 순서** 단계를 전환하며 확인할 수 있습니다. 왼쪽 패널에서도 동일한 단계로 이동합니다.
- **실제 모바일:** 목업 프레임 없이 앱 UI만 표시되며, 상단 탭으로 화면을 전환합니다.
- 체크인 등록 후 자동으로 **오늘 방문** 화면으로 이동합니다.
